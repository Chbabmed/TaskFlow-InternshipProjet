...
export default function Departement_Employees() {
    ...
    return (
        <div>
            <div className="drop-shadow-md  headerNav h-40 mb-3 min-h-screen h-fit  p-6 " style={{background : '#F0F2F5'}}>
                ...
                <EmployeesTable data = {Data} title = "Les Responsbles des Services" />
                <div className="h-6" ></div>
                <EmployeesTable data = {Data} title = "Les Responsbles des Tâches" />
